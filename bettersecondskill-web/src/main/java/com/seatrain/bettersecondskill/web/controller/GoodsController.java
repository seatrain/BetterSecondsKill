...
public class GoodsController {
  ...
  public CustomizedResponseEntity<Integer> create(
      @Valid GoodsDTO goodsDTO
  ) {
    Integer id = miaoShaGoodsService.create(goodsDTO);
  ...
  public CustomizedResponseEntity<GoodsVo> getInfo(
    ...
    GoodsVo goodsVo = miaoShaGoodsService.selectInfo(id);
  ...
  public CustomizedResponseEntity<List<GoodsVo>> getList(
    ...
    List<GoodsVo> goodsVoList = miaoShaGoodsService.selectList();
